...
|---|---|
| ![Tela do totem](docs/screenshots/totem-menu.svg) | ![Painel da cozinha](docs/screenshots/kds-painel.svg) |

| Customização do item | Pedido confirmado |
|---|---|
| ![Customização](docs/screenshots/totem-customizar.svg) | ![Confirmação](docs/screenshots/totem-confirmado.svg) |
...
│   └── screenshots/
│       ├── totem-menu.svg
│       ├── totem-customizar.svg
│       ├── totem-confirmado.svg
│       └── kds-painel.svg
│
├── totem-backend/
│   ├── package.json
...
-  [Docker Desktop](https://www.docker.com/products/docker-desktop/), para rodar via containers (Opcional)
